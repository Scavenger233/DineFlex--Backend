...
VALUES
    (1, 'Bella Italia', 'Cork', 'Italian', 'Authentic Italian cuisine in the heart of Cork', '15 Oliver Plunkett Street, Cork', '+353 21 345 6789', 'https://example.com/bella.jpg', 'Daily: 12:00-22:30', TRUE, TRUE),
    (2, 'The Sizzling Grill', 'Dublin', 'Steakhouse', 'Premium steaks and grilled specials', '12 Castle Road, Dublin', '+353 1 234 5678', 'https://example.com/sizzling.jpg', 'Mon-Sun: 12:00-22:00', TRUE, FALSE);
...
VALUES
    (1, 1, '2025-05-10', '17:30', 'EARLY_BIRD', 1, TRUE),
    (2, 1, '2025-05-10', '18:00', 'EARLY_BIRD', 1, TRUE),
    (3, 1, '2025-05-10', '19:30', 'REGULAR', NULL, TRUE),
    (4, 1, '2025-05-10', '20:30', 'LAST_MINUTE', 2, TRUE);
...
VALUES
    (1, '2025-05-10', '17:30', 4, 'CONFIRMED', 'DINE12345', 1, 1, 1);